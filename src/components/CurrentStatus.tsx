  ...
  return (
    <div className="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100">
      <div className="bg-gradient-to-r from-emerald-500 to-teal-600 p-6 text-white text-center">
        <h2 className="text-emerald-100 font-medium uppercase tracking-wider text-sm mb-2">Responsabilidade Atual</h2>
      ...
      <div className="p-6 bg-white">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="text-gray-600 text-sm">
            <p>Não esqueça de colocar o lixo para fora no dia da coleta!</p>
          </div>
          <button 
            disabled
            ...
            title="Notificação desabilitada"
          >
            <span>Notificar Vizinho</span>
          </button>
        </div>
      </div>
    </div>
